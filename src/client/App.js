    ...
    return(
      <div className="tot">
        ...
        <div className="chiaraporcellini row">
          ...
          <div className="nome col-6"><p className="chiaraporcellini">Chiara Porcellini</p></div>

          <div className="testo col-6"><p className="chiaraporcellini">Il filosofo Hobbes, intorno al
        ...
        <div className="caterinalaghi row">
          ...
          <div className="nome col-6"><p className="caterinalaghi">Caterina Laghi</p></div>

          <div className="testo col-6"><p className="caterinalaghi">In effetti, durante tutta la nostra
        ...
        <div className="francescofranco row">
          ...
          <div className="nome col-6"><p className="francescofranco">Francesco Franco</p></div>

          <div className="testo col-6"><p className="francescofranco">Il simbolo dello yin e yang ci
        ...
        <div className="margheritatura row">
          ...
          <div className="nome col-6" id="margheritatura"><p className="margheritatura">Margherita
            Tura</p></div>

          <div className="testo col-6" id="margheritatura"><p className="margheritatura">La nostra società
        ...
        <div className="emanuelemigani row">
          ...
          <div className="nome col-6" id="emanuelemigani"><p className="emanuelemigani">Emanuele
            Migani</p></div>

          <div className="testo col-6" id="emanuelemigani"><p className="emanuelemigani">L’uomo si chiede
        ...
        <div className="caterinarughi row">
          ...
          <div className="nome col-6" id="caterinarughi"><p className="caterinarughi">Caterina Rughi</p>
          </div>

          <div className="testo col-6" id="caterinarughi"><p className="caterinarughi">L’odio è la via più
        ...
        <div className="giuliascozzoli row">
          ...
          <div className="nome col-6" id="giuliascozzoli"><p className="giuliascozzoli">Giulia
            Scozzoli</p></div>

          <div className="testo col-6" id="giuliascozzoli"><p className="giuliascozzoli">L’odio è uno
        ...
        <div className="riccardorossi row">
          ...
          <div className="nome col-6" id="riccardorossi"><p className="riccardorossi">Riccardo Rossi</p>
          </div>

          <div className="testo col-6" id="riccardorossi"><p className="riccardorossi">Le persone sfogano
        ...
        <div className="alessandroaldini row">
          ...
          <div className="nome col-6" id="alessandroaldini"><p className="alessandroaldini">Alessandro
            Aldini</p></div>

          <div className="testo col-6" id="alessandroaldini"><p className="alessandroaldini">Qui si vede
        ...
        <div className="biancabrunacci row">
          ...
          <div className="nome col-6" id="biancabrunacci"><p className="biancabrunacci">Bianca
            Brunacci</p></div>

          <div className="testo col-6" id="biancabrunacci"><p className="biancabrunacci"> Il fatto che
        ...
        <div className="costanzagiannini row">
          ...
          <div className="nome col-6" id="costanzagiannini"><p className="costanzagiannini">Costanza
            Giannini</p></div>

          <div className="testo col-6" id="costanzagiannini"><p className="costanzagiannini">È
        ...
        <div className="simonecarro row">
          ...
          <div className="nome col-6" id="simonecarro"><p className="simonecarro">Simone Carro</p></div>

          <div className="testo col-6" id="simonecarro"><p className="simonecarro">Ciò fa riflettere su
        ...
        <div className="chiarabenati row">
          ...
          <div className="nome col-6" id="chiarabenati"><p className="chiarabenati">Chiara Benati</p>
          </div>

          <div className="testo col-6" id="chiarabenati"><p className="chiarabenati">Conosciamo
        ...
        <div className="matildebassi row">
          ...
          <div className="nome col-6" id="matildebassi"><p className="matildebassi">Matilde Bassi</p>
          </div>

          <div className="testo col-6" id="matildebassi"><p className="matildebassi">La sicurezza che ha
        ...
        <div className="ceciliaspazzoli row">
          ...
          <div className="nome col-6" id="ceciliaspazzoli"><p className="ceciliaspazzoli">Cecilia
            Spazzoli</p></div>

          <div className="testo col-6" id="ceciliaspazzoli"><p className="ceciliaspazzoli">Se veramente
        ...
        <div className="andreapaoli row">
          ...
          <div className="nome col-6" id="andreapaoli"><p className="andreapaoli">Andrea Paoli</p></div>

          <div className="testo col-6" id="andreapaoli"><p className="andreapaoli">Perché oggi abbiamo
        ...
        <div className="matildevalentini row">
          ...
          <div className="nome col-6" id="matildevalentini"><p className="matildevalentini">Matilde
            Valentini</p></div>

          <div className="testo col-6" id="matildevalentini"><p className="matildevalentini">Ciò che più
        ...
        <div className="francescaspazzoli row">
          ...
          <div className="nome col-6" id="francescaspazzoli"><p className="francescaspazzoli">Francesca
            Spazzoli</p></div>

          <div className="testo col-6" id="francescaspazzoli"><p className="francescaspazzoli">Possibile
        ...
        <div className="andrearicci row">
          ...
          <div className="nome col-6" id="andrearicci"><p className="andrearicci">Andrea Ricci</p></div>

          <div className="testo col-6" id="andrearicci"><p className="andrearicci">Qui l'odio si presenta
        ...
        <div className="laurafabbri row">
          ...
          <div className="nome col-6" id="laurafabbri"><p className="laurafabbri">Laura Fabbri</p></div>

          <div className="testo col-6" id="laurafabbri"><p className="laurafabbri">Tutti odiamo qualcosa,
        ...
        <div className="chiaraporcellini2 row">
          ...
          <div className="nome col-6" id="chiaraporcellini2"><p className="chiaraporcellini2">Chiara
            Porcellini</p></div>

          <div className="testo col-6" id="chiaraporcellini2"><p className="chiaraporcellini2">Nonostante
        ...
        <div className="beatricescheda row">
          ...
          <div className="nome col-6" id="beatricescheda"><p className="beatricescheda">Beatrice
            Scheda</p></div>

          <div className="testo col-6" id="beatricescheda"><p className="beatricescheda">Possiamo trovare
        ...
        <div className="matildevalentini2 row">
          ...
          <div className="nome col-6" id="matildevalentini2"><p className="matildevalentini2">Matilde
            Valentini</p></div>

          <div className="testo col-6" id="matildevalentini2"><p className="matildevalentini2">L’empatia
        ...
        <div className="alessandroseveri row">
          ...
          <div className="nome col-6" id="alessandroseveri"><p className="alessandroseveri">Alessandro
            Severi</p></div>

          <div className="testo col-6" id="alessandroseveri"><p className="alessandroseveri">L’amore
        ...
        <div className="chiarabenati2 row">
          ...
          <div className="nome col-6" id="chiarabenati2"><p className="chiarabenati2">Chiara Benati</p>
          </div>

          <div className="testo col-6" id="chiarabenati2"><p className="chiarabenati2">La risposta per noi
        ...
        <div className="elenatisselli row">
          ...
          <div className="nome col-6" id="elenatisselli"><p className="elenatisselli">Elena Tisselli</p>
          </div>

          <div className="testo col-6" id="elenatisselli"><p className="elenatisselli">Se ognuno impara a
        ...
        <div className="giovannitedaldi row">
          ...
          <div className="nome col-6" id="giovannitedaldi"><p className="giovannitedaldi">Gaia Vitali</p>
          </div>

          <div className="testo col-6" id="giovannitedaldi"><p className="giovannitedaldi">Se noi ci
        ...
        <div className="chiaracontavalli row">
          ...
          <div className="nome col-6" id="chiaracontavalli"><p className="chiaracontavalli">Riccardo
            Rossi</p></div>

          <div className="testo col-6" id="chiaracontavalli"><p className="chiaracontavalli">Solo se
        ...
        <div className="gaiavitali row">
          ...
          <div className="nome col-6" id="gaiavitali"><p className="gaiavitali">Gaia Vitali</p></div>

          <div className="testo col-6" id="gaiavitali"><p className="gaiavitali">Non cambieremo il mondo,
        ...
        <div className="leonardocasadei row">
          ...
          <div className="nome col-6" id="leonardocasadei"><p className="leonardocasadei">Leonardo
            Casadei</p></div>

          <div className="testo col-6" id="leonardocasadei"><p className="leonardocasadei">E non possiamo
            che pregare, in silenzio.</p></div>
        </div>

        <div className="federicazonta row">

          <div className="nome col-6" id="federicazonta"><p className="federicazonta">Federica Zonta</p>
          </div>

          <div className="testo col-6" id="federicazonta">
            <p className="federicazonta"><img src={FedeTonza} /></p></div>
        </div>

        <div className="marcovalentini row">

          <div className="nome col-6" id="marcovalentini"><p className="marcovalentini">Marco
            Valentini</p></div>

          <div className="testo col-6" id="marcovalentini">
